...
const ERROR_MESSAGES = {
  ...
  'TypeError: Failed to fetch': 'Connection problem. Please check your internet connection.',
  ...
  // Workout errors
  'Failed to fetch workout': 'Could not load today\'s workout. Please try again.',
  ...
  'Invalid JSON': 'The uploaded file format is invalid. Please check your JSON file.',
  ...
  json: (jsonString) => {
    try {
      ...
      if (parsed.name && parsed.schedule) {
        ...
        throw new Error('Invalid JSON: Must include "name" and "schedule" fields');
      }
    } catch (error) {
